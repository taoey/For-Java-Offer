...
- 与时区无关。默认情况下，MySQL 以一种可排序的、无歧义的格式显示 DATATIME 值，例如“2008-01-16 22:37:08”，这是 ANSI 标准定义的日期和时间表示方法。
...
本文在此只讲述索引的相关原理，对于索引的优化及使用，可查看《MySQL调优》
